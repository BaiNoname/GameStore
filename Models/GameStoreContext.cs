    ...
    public class GameStoreContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Game>(entity =>
            {
                ...
                entity.Property(e => e.MaTheLoai).HasColumnName("matheloai");
                entity.Property(e => e.Gia).HasColumnName("gia").HasPrecision(18, 2);
            ...
            modelBuilder.Entity<GiaoDich>(entity =>
            {
                ...
                entity.Property(e => e.SoTienGiam).HasColumnName("sotiengiam").HasPrecision(18, 2);
                entity.Property(e => e.NgayMua).HasColumnName("ngaymua").HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(e => e.ThanhTien).HasColumnName("thanhtien").HasPrecision(18, 2);
            ...
            modelBuilder.Entity<ChiTietGioHang>(entity =>
            {
                ...
                entity.Property(e => e.MaGH).HasColumnName("magh");
                entity.Property(e => e.MaGame).HasColumnName("magame");
                entity.Property(e => e.DonGiaHienTai).HasColumnName("dongiahientai").HasPrecision(18, 2);
            ...
            modelBuilder.Entity<ChiTietGiaoDich>(entity =>
            {
                ...
                entity.Property(e => e.MaGD).HasColumnName("magd");
                entity.Property(e => e.MaGame).HasColumnName("magame");
                entity.Property(e => e.DonGia).HasColumnName("dongia").HasPrecision(18, 2);
            ...
            // HoanTra (refund)
            // =========================
            modelBuilder.Entity<HoanTra>(entity =>
            {
                entity.ToTable("hoantra");
                entity.HasKey(e => e.MaHoanTra);

                entity.Property(e => e.MaHoanTra).HasColumnName("mahoantra");
                entity.Property(e => e.MaNguoiDung).HasColumnName("manguoidung");
                entity.Property(e => e.MaGame).HasColumnName("magame");
                entity.Property(e => e.MaGD).HasColumnName("magd");
                entity.Property(e => e.LyDo).HasColumnName("lydo");
                entity.Property(e => e.NoiDung).HasColumnName("noidung");
                entity.Property(e => e.SoTienHoan).HasColumnName("sotienhoan").HasPrecision(18, 2);
                entity.Property(e => e.TrangThai).HasColumnName("trangthai").HasDefaultValue("Pending");
                entity.Property(e => e.NgayYeuCau).HasColumnName("ngayyeucau").HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(e => e.NgayXuLy).HasColumnName("ngayxuly");
                entity.Property(e => e.GhiChuAdmin).HasColumnName("ghichuadmin");
                ...
                entity.HasOne(e => e.NguoiDung)
                      ...
                      .HasForeignKey(e => e.MaNguoiDung)
                      .OnDelete(DeleteBehavior.Restrict)
                      .HasConstraintName("fk_hoantra_nguoidung");

                entity.HasOne(e => e.Game)
                      .WithMany()
                      .HasForeignKey(e => e.MaGame)
                      .OnDelete(DeleteBehavior.Restrict)
                      .HasConstraintName("fk_hoantra_game");
            });
            ...
            modelBuilder.Entity<KhuyenMai>(entity =>
            {
                ...
                entity.Property(e => e.MoTa).HasColumnName("mota");
                entity.Property(e => e.LoaiGiam).HasColumnName("loaigiam").HasMaxLength(20).HasDefaultValue("Percent");
                entity.Property(e => e.GiaTri).HasColumnName("giatri").HasPrecision(18, 2);
                entity.Property(e => e.GiamToiDa).HasColumnName("giamtoida").HasPrecision(18, 2);
                entity.Property(e => e.DonToiThieu).HasColumnName("dontoithieu").HasPrecision(18, 2);
                entity.Property(e => e.SoLuong).HasColumnName("soluong");
                entity.Property(e => e.DaDung).HasColumnName("dadung").HasDefaultValue(0);
                entity.Property(e => e.NgayBatDau).HasColumnName("ngaybatdau");
                entity.Property(e => e.NgayKetThuc).HasColumnName("ngayketthuc");
                entity.Property(e => e.IsActive).HasColumnName("isactive").HasDefaultValue(true);
                entity.Property(e => e.CreatedAt).HasColumnName("createdat").HasDefaultValueSql("CURRENT_TIMESTAMP");

                entity.Ignore(e => e.ConLuot);
                entity.HasIndex(e => e.Code).IsUnique();
            });

            // =========================
            // NguoiDungKhuyenMai (user lấy/dùng mã)
            // =========================
            modelBuilder.Entity<NguoiDungKhuyenMai>(entity =>
            {
                entity.ToTable("nguoidungkhuyenmai");
                ...
                entity.Property(e => e.MaKM).HasColumnName("makm");
                entity.Property(e => e.MaGD).HasColumnName("magd");
                entity.Property(e => e.NgayLay).HasColumnName("ngaylay").HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(e => e.DaSuDung).HasColumnName("dasudung").HasDefaultValue(false);
                entity.Property(e => e.NgaySuDung).HasColumnName("ngaysudung");

                entity.HasIndex(e => new { e.MaNguoiDung, e.MaKM }).IsUnique();
                ...
                entity.HasOne(e => e.NguoiDung)
                      ...
                      .HasForeignKey(e => e.MaNguoiDung)
                      .OnDelete(DeleteBehavior.Restrict)
                      .HasConstraintName("fk_ndkm_nguoidung");

                entity.HasOne(e => e.KhuyenMai)
                      .WithMany(k => k.NguoiDungKhuyenMais)
